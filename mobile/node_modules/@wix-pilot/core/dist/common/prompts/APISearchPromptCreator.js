...
exports.APISearchPromptCreator = void 0;
const APIFormatter_1 = require("../../common/APIFormatter");
class APISearchPromptCreator {
    apiCatalog;
    apiFormatter;
    constructor(apiCatalog) {
        this.apiCatalog = apiCatalog;
        this.apiFormatter = new APIFormatter_1.APIFormatter(apiCatalog);
    }
    createPrompt(step, viewAnalysisResult) {
        return [
            "# API Method Search",
            "",
            "## Task Description",
...
exports.APISearchPromptCreator = APISearchPromptCreator;
